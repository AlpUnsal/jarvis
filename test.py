...
def query_coding_model():
    ...
    while True:
        try:
            # Continuously listen using VAD
            user_input = listen_with_vad(model, utils)
